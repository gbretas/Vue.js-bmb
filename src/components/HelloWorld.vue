        ...
        <div class="card institution">
          <div class="card-body">
            <form>
              ...
              <br />
              <label>Nível de Curso:</label>
              <select class="form-select mb-3" aria-label="Nível do Curso">
                <option selected>Selecionar</option>
              </select>
              <label>Área de Estudo:</label>
              <select class="form-select mb-3" aria-label="Área de Estudo">
                <option selected>Selecionar</option>
              </select>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <p>Type: <b> {{ data?.content_type?.name }} </b><br />
                          Duração: <br /> <b>{{ data?.duration }} {{ data?.duration_type }} </b><br />
          ...
          <div class="card institution" v-for="(data, index) in CS_DATA_LIST" :key='data'>
            <div class="card-body">
              ...
              <div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-3">
                            <p>Type: <b> {{ data1?.content_type?.name }} </b><br />
                              Duração: <br /> <b>{{ data1?.duration }} {{ data1?.duration_type }} </b><br />
                ...
                <div v-if="data.scholarships.length == 0">
                  <p>Não há bolsas disponíveis com os itens selecionados, mude a unidade, turno ou modalidade
                    selecionada.
                  </p>
                </div>
              </div>
